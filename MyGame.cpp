...
public:
    ...
    void move(float deltaTime) {
        ...
        if (Keyboard::isKeyPressed(Keyboard::Space) && bulletIndex >= 0 && CanShoot) {
        ...
        // dashing 
        if (Keyboard::isKeyPressed(Keyboard::RAlt) && CanDash && IsLevelTwo) {
    ...
    void PlayerAnimation() {
        ...
        if (Keyboard::isKeyPressed(Keyboard::Space) && AnimShooting !=0) {
...
void Completetion(Player &player) {
    ...
    bfCompletion.loadFromFile("Chosen/Sound/Completion/Bear McCreary - The All-Father _ God of War Ragnar k (Original Soundtrack)(MP3_320K)-[AudioTrimmer.com]-[AudioTrimmer.com].mp3");
